...
class TeamDetailsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        guard let teamId else {
            showErrorAlert(message: "Invalid team.")
            return
        }
...
extension TeamDetailsViewController: UITableViewDataSource {
    ...
    func tableView(
        ...
        let cell = tableView.dequeueReusableCell(
            withIdentifier: "TeamDetailsCell",
            for: indexPath
        ) as! TeamDetailsCell
...
extension TeamDetailsViewController: UITableViewDelegate {
    ...
    func tableView(
        ...
        label.text = presenter.groupedPlayers()[section].type
